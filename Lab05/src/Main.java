...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ClientePF cliente1 = new ClientePF("Tico", "0012345678",
            ...
            "Masculino", "Ensino Superior", new Date(102, 11, 16),
            listaVeiculos1);
        ...
        ClientePJ cliente2 = new ClientePJ(
            ...
            "tycho.brahe@gmail.com", "11222333000181", new Date(122, 4, 23),
            20, listaFrotas1);
        ...
        Condutor condutor1 = new Condutor(
            ...
            "bigblue@hotmail.com", new Date(84, 11, 27), listaSinistros1);
        ...
        Seguro seguro1 = new SeguroPF(
            new Date(122, 4, 4), new Date(123, 5, 4), seguradora1, listaSinistros2,
        ...
        Seguro seguro2 = new SeguroPJ(
            new Date(102, 1, 1), new Date(132, 1, 1), seguradora1, listaSinistros3,
        ...
        Sinistro sinistro1 = new Sinistro(
            new Date(123, 4, 24), "Esmolândia, Suécia", condutor1, seguro1);
        ...
        Sinistro sinistro2 = new Sinistro(
            new Date(123, 5, 16), "Uplândia, Suécia", condutor1, seguro2 );
                ...
                while (inputOperacao2 != MenuCadastrar.VOLTAR.operacao) {
                    ...
                    if (inputOperacao2 == MenuCadastrar.CADASTRAR_CLIENTE_PF.operacao) {
                        ...
                        ClientePF c = new ClientePF(
                            ...
                            cGenero, cEducacao, new Date(), new ArrayList<Veiculo>());
                        ...
                        ClientePJ c = new ClientePJ(
                            ...
                            cCNPJ, new Date(), cQtdFunc, new ArrayList<Frota>());
                        ...
                        if (pos >= 0) {
                            ...
                            Seguro s = new SeguroPF(new Date(), new Date(), seguradoraSelecionada,
                        ...
                        if (pos >= 0) {
                            ...
                            Seguro s = new SeguroPJ(new Date(), new Date(), seguradoraSelecionada,
                            new ArrayList<Sinistro>(), new ArrayList<Condutor>(), 
                ...
                for (int i = 0; i < segurosEmAnalise.size(); i++) {
                    if (segurosEmAnalise.get(i).getId() == Integer.parseInt(sSeguro)) {
                        ...
                        Sinistro s = new Sinistro(
                            new Date(), sEndereco, condutor1, segurosEmAnalise.get(i));
